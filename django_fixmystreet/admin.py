from django_fixmystreet.models import UserProfile,EmailRule,Ward,ReportCategory,City, ReportCategoryClass, FaqEntry, Councillor,ReportCategorySet
...
class EmailRuleAdmin(admin.ModelAdmin):
    ...
    change_list_template = 'admin/django_fixmystreet/emailrules/change_list.html'
