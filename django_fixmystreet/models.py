...
class CCEmailMessage(EmailMessage):
    def __init__(self, subject='', body='',
                 from_email=None, to=None, cc=None, bcc=None,
                 connection=None, attachments=None,
                 headers=None):
        super(CCEmailMessage, self).__init__(
    ...
    def recipients(self):
        ...
        """
        return super(CCEmailMessage,
                     self).recipients() + self.cc
